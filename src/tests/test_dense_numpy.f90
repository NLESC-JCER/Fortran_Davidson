program main
  ...
  real(dp), dimension(50, 3) :: eigenvectors_DPR, eigenvectors_GJD, eigenvectors_DPR_gen, eigenvectors_GJD_gen
  ...
  call generalized_eigensolver(mtx, eigenvalues_GJD_gen, eigenvectors_GJD_gen, 3, "GJD", 1000, 1d-8, iter_i, 10, stx)
  call generalized_eigensolver(mtx, eigenvalues_DPR_gen, eigenvectors_DPR_gen, 3, "DPR", 1000, 1d-8, iter_i, 10, stx)
